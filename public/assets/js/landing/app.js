...
\
هزینه شرکت در برنامه، در صورت خرید بلیط تا ۲۴ ساعت قبل (ساعت ۸ روز ۱۸ دسامبر) ، برای دانشجویان ۷ دلار و برای غیر دانشجویان ۱۰ دلار، و در روز برگزاری برنامه قیمت بلیط برای همگی عزیزان ۱۵ دلار خواهد بود.\n\n\
...
۵- لطفا همراه داشتن لبخند رو فراموش نکنید!!!',
                images: [
                    '../images/game-night/1.jpg',
                    '../images/game-night/2.jpg',
                    '../images/game-night/3.jpg',
                    '../images/game-night/4.jpg',
                    '../images/game-night/5.jpg'
                ],
                id: 'id1'
            },
            {
                title: 'Bowling Night',
                content: 'سلام دوستان، دلتون تنگ شده واسه دیدن دوستاتون؟ واسه کل‌کل کردن چطور؟ پس کفشای بولینگتون رو بپوشید که چند دست بولینگ بزنیم دور هم. کفش بولینگ ندارید؟؟؟ مشکلی نداره، ما هم نداریم، اونجا امانت می‌گیریم . اونجا کجاست؟ Union Underground. کی اونجا باشیم؟ پنج‌شنبه ۲۲ اکتبر (آره، همین پنج‌شنبه)، ساعت ۷ تا ۹ شب. بولینگ دوست ندارید؟ چی؟ واقعا؟؟؟… اشکال نداره. میز بیلیارد و air hockey‌ هم داره اونجا. (البته اینا همه بهانه است، مهم دیدن دوستانه.:) ) قیمتش چقدره؟ اینجا می‌تونید لیست قیمتا رو ببینید. پس پنج‌شنبه با کلی انرژی بیاید که می‌خوایم حسابی کل‌کل کنیم. و صد البته که لبخنداتون رو جا نذارید، با خودتون بیاریدشون. :) منتظرتونیم، برد PSS'
                ,images: [
                '../images/game-night/1.jpg'
            ],
                id: 'id0'
...
پس قرارمون جمعه ساعت ۶ عصر. لطفا هر چی بازی باحال دارید بیارید با خودتون، ضرر نداره. منتظر دیدن خنده‌هاتون هستیم.',
                images: [
                    ...
                    '../images/game-night/4.jpg',
                    '../images/game-night/5.jpg',
                    '../images/game-night/6.jpg',
                    '../images/game-night/7.jpg'
                ],
                id: 'id2'
            }
        ];
